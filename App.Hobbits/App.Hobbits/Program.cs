...
namespace MyApp
{
    internal class Program
    {
        ...
        static void ShowCourseMenu(CourseHelper courseHelper)
        {
            ...
            Console.WriteLine("10. Remove a submissions from a course");
            Console.WriteLine("11. Update submission in a course");
            Console.WriteLine("12. Add a modules to a course");
            ...
            Console.WriteLine("16. Update an announcement in a course");
            Console.WriteLine("17. Remove an announcement from a course");
            Console.WriteLine("18. List all courses");               
            Console.WriteLine("19. Search for a course");           
