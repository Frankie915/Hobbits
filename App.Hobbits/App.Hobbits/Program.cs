...
namespace MyApp
{
    internal class Program
    {
        ...
        static void ShowCourseMenu(CourseHelper courseHelper)
        {
            ...
            Console.WriteLine("10. Delete a submissions from a course");
            Console.WriteLine("11. Add a modules to a course");
            ...
            Console.WriteLine("15. Update an announcement in a course");
            Console.WriteLine("16. Delete an announcement from a course");
            Console.WriteLine("17. List all courses");               
            Console.WriteLine("18. Search for a course");           
